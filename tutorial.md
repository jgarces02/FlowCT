...
>
> ```{r}
> # (NOTE: remove.pop funtion is deprecated, use these lines instead)
> fcsL_rm <- fcsL[,!(fcsL$PARC_L_named %in% c("Unc", "debris"))]
> fcsL_rm$PARC_L_named <- droplevels(fcsL_rm$PARC_L_named) #optional to avoid empty labels
> ```
